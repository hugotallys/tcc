...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \label{fig:subfig2}
    \end{subfigure}
    \caption{Configuração final do manipulador nos experimentos do segundo cenário (métrica distância das juntas).}
...
de \(k_0\) maior para convergir para a solução ótima.
